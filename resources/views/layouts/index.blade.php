...
<head>
<meta charset="utf-8"/>
<title>SIA Park Hotel | Cupons de desconto</title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ppage-sidebar-closed-hide-logo">
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="index.html">
				<img src="{{ asset('admin/img/logo.png') }}" alt="logo" class="logo-default" width="300" height="40"/>
				</a>
						...
						<ul class="sub-menu">
							<li>
								<a href="{{ route('tickets') }}">
									<span class="badge badge-roundless badge-danger"></span>Cupons</a>
							</li>
						</ul>
					</li>
	...
	<div class="page-footer">
		<div class="page-footer-inner">
			2017 &copy; Brasal Centro Corporativo - Inovação tecnologica.
		</div>
